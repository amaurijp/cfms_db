...
def main():
    ...
    classPDFs.classify_docs(update_DB = True)
    ...
    t_objects.get_text_objects(save_TXT = False, save_JSON = False, filter_by_TF = False)
    ...
    t_objects.find_IDF(min_token_appereance = 2)
    t_objects.set_TFIDF_log_and_sent_stats(file_batch_size = 2)
